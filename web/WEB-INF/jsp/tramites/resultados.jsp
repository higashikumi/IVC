    ...
    <body>
        ...
        <div id="main">
            <div class="general-mapper">
                &gt; <a href="tramites.htm">Guía de Trámites</a>
            </div>
            <!-- Start H1 Title -->
                    ...
                    <div class="boxes-padding fullpadding choose-entidad">
                        ...
                        <div class="split23">
                            ...
                            <div class="res-tramite">
                                <h4>Nombre del Trámite</h4>
                                <div>
                                    Tramite para realizar la implementación de los esquemas de... (Breve descripción del trámite)
                                ...
                                <a href="tramite.htm">Ver trámite completo</a>
                            </div>                             
                            <div class="res-tramite">
                                <h4>Nombre del Trámite</h4>
                                <div>
